...
This repository is a reference implementation. The goal is to make the interface
contract reviewable and buildable without overstating real hardware support.
